...
export  const data=[
  ...
  },
  {
    ...
    option1:"oyin",
    option2:"bosh",
      option3:"ozgarmas ozgaruvchi",
      option4:"qol",
      answers:3
  },
  {
      question:"count nma",
      option1:"bironta kiymatni 1 ga oshirilishi",
      option2:"osmon",
      option3:"quyosh",
      option4:"stol",
      answers:1
  ...
  {
      question:"Nechta data types bor",
      option1:"5",
      option2:"10",
      option3:"8",
      option4:"12",
...
<div className="div">
         ...
         <button className='btn3'>
                   ...
                   <div className="card">
                   <img src="./images/card-3.svg" alt="card" className="i" />
             <h1 className="html1" >Javascript</h1>
                   </div>
